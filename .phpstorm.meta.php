...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/piotr/repos/priv/geldsack/public/storage' => 'string',
...
'cors.exposed_headers','cors.max_age','cors.supports_credentials','view.paths','view.compiled',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/piotr/repos/priv/geldsack/public/storage','fortify.guard','fortify.middleware',
...
'fortify.redirects.register','fortify.redirects.email-verification','fortify.redirects.password-reset','fortify.features','inertia.ssr.enabled',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','mail.markdown.extensions','queue.default',
...
'verification.verify','verification.send','password.confirm','password.confirmation','password.confirm.store',
...
'home','dashboard','wallets.index','wallets.create','wallets.store',
'wallets.show','wallets.edit','wallets.update','wallets.destroy',
